      ...
      try {
        const categoriesWithServices = await Promise.all(
          serviceCategories.map(async (category) => {
            try {
              const response = await axios.get(`https://themabinti-main.onrender.com/api/services/${category.id}`);
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-purple-400 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Find the Perfect Beauty & Lifestyle Services</h1>
          <p className="text-lg md:text-xl mb-8 max-w-3xl mx-auto">
            Connect with top service providers in Kenya for all your beauty, fashion, health, and lifestyle needs.
          </p>
          <Button 
